import { drawArrow, drawText, selectObject } from "../main/fsm";
import { state } from "../main/state";
import { hitTargetPadding, nodeRadius } from "../main/constants";

export class SelfLink {
	/**
	 * @param {import("./node").StateNode} node
	...
	draw(c) {
		...
		drawText(c, this.text, textX, textY, this.anchorAngle, state.selectedObject == this);
